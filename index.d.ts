...
type CommonProps<ItemType> = {
  ...
  /**
   * When set to true the library will calcualte the total dimensions taking into account padding in style prop, and padding + maxWidth in contentContainerStyle prop
   */
